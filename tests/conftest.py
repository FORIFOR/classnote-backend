...
_aiplatform = mock_pkg("google.cloud.aiplatform")
_aiplatform_version = mock_pkg("google.cloud.aiplatform.version")
_aiplatform_version.__version__ = "0.0.0-test"
_aiplatform.version = _aiplatform_version
mock_pkg("google.cloud.aiplatform_v1")
mock_pkg("google.cloud.aiplatform_v1.types")
mock_pkg("vertexai")
mock_pkg("vertexai.generative_models")
